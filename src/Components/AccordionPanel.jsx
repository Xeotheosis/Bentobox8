  ...
  return (
    <div
      ...
      <div
        ...
        <svg
          className="bg-[#06b6d4] w-[3rem] aspect-square p-3 rounded-full fill-white"
          ...
          {isActive && (
            <>
              <a
                href={source}
                target="_blank"
                className="p-3 rounded-full w-fit font-bold tracking-wider  uppercase  text-white  hover:text-[#06b6d4] text-2xl cursor-pointer text-center poppins">
                View Demo
              </a>
