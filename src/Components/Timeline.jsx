  ...
  return (
    <section className="md:timeline-container bg-box-color rounded-xl xl:col-span-2 xl:row-span-2 scale-up-center-sixth">
      <div className="timeline">
        ...
        <div className="bg-white p-2 px-3 second-message rounded-l-xl justify-self-end  self-center text-right w-full max-w-[7.5rem]">
          <p className="font-bold text-base lg:text-xs xl:text-base">
            Junior Analyst
          </p>
        </div>

        <div className="bg-white p-2 third-message rounded-r-xl self-end px-3 w-full max-w-[7.5rem]">
          <p className="font-bold text-base lg:text-xs xl:text-base">
            Account Manager
          </p>
        </div>
