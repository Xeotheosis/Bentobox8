...
const FrontMentorProfile = ({
  ...
  return (
    <section className={highlightedProject}>
      ...
      <div className="absolute p-4 h-full w-full top-0 shadow-box rounded-xl flex items-center justify-center opacity-0 hover:opacity-100  transition delay-100 duration-500">
